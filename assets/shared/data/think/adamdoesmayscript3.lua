...
idle_xml_name = 'AdamBehind Idle'
left_xml_name = 'AdamBehind Left'
down_xml_name = 'AdamBehind Down'
up_xml_name = 'AdamBehind Up'
right_xml_name = 'AdamBehind Right'
...
name_of_character_xml = 'AdamBehind'
name_of_character = 'AdamBehind'

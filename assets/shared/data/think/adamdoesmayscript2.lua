...
idleoffsets = {'-10', '13'} -- I recommend you have your idle offset at 0
leftoffsets = {'4', '23'}
downoffsets = {'-9', '5'}
upoffsets = {'-20', '50'}
rightoffsets = {'-22', '25'}
...
idle_xml_name = 'AdamAngry Idle'
left_xml_name = 'AdamAngry Left'
down_xml_name = 'AdamAngry Down'
up_xml_name = 'AdamAngry Up'
right_xml_name = 'AdamAngry Right'

left_miss_xml_name = 'poopoo'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'poopoo'   --
up_miss_xml_name = 'poopoo'       --
right_miss_xml_name = 'poopoo' --
...
name_of_character_xml = 'AdamAngry'
name_of_character = 'AdamAngry'
name_of_notetype = 'adamdoesmay'

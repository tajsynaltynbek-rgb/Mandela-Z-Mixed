...
idle_xml_name = 'Jonah Idle'
left_xml_name = 'Jonah Left'
down_xml_name = 'Jonah Down'
up_xml_name = 'Jonah Up'
right_xml_name = 'Jonah Right'
...
name_of_character_xml = 'Jonah'
name_of_character = 'Jonah'

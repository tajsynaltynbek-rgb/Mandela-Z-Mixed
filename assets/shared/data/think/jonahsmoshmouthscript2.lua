...
idle_xml_name = 'JonahFear Idle'
left_xml_name = 'JonahFear Left'
down_xml_name = 'JonahFear Down'
up_xml_name = 'JonahFear Up'
right_xml_name = 'JonahFear Right'
...
name_of_character_xml = 'JonahFear'
name_of_character = 'JonahFear'

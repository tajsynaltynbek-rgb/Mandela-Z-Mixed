...
idle_xml_name = 'JonahBehind Idle'
left_xml_name = 'JonahBehind Left'
down_xml_name = 'JonahBehind Down'
up_xml_name = 'JonahBehind Up'
right_xml_name = 'JonahBehind Right'

left_miss_xml_name = 'homophobic goku'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'homophobic goku'   --
up_miss_xml_name = 'homophobic goku'       --
right_miss_xml_name = 'homophobic goku' --
...
name_of_character_xml = 'JonahBehind'
name_of_character = 'JonahBehind'
name_of_notetype = 'jonahsmoshmouth'
